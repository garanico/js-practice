...
const designerForm = document.forms.designer;//dot notation specifically for forms

const h1 = document.querySelector('h1');//
designerForm.addEventListener('submit', function(event) {
    event.preventDefault();//default for "submit" is to send the data to the internet.  preventDefault is to override the default functionality.
